(function ($) {
  ...
  if ($exampleEchartSmothedLine.length) {
    ...
    var $exampleEchartSmothedLineActive = echarts.init(
      document.getElementById($exampleEchartSmothedLineId)
    );
  ...
  if ($exampleEchartBasicArea.length) {
    ...
    var $exampleEchartBasicAreaActive = echarts.init(
      document.getElementById($exampleEchartBasicAreaId)
    );
    // specify chart configuration item and data
    var option = {
      xAxis: {
  ...
  if ($exampleEchartStepLine.length) {
    ...
    var $exampleEchartStepLineActive = echarts.init(
      document.getElementById($exampleEchartStepLineId)
    );
    // specify chart configuration item and data
    var option = {
      tooltip: {
  ...
  if ($exampleEchartBarSimple.length) {
    ...
    var $exampleEchartBarSimpleActive = echarts.init(
      document.getElementById($exampleEchartBarSimpleId)
    );
    // specify chart configuration item and data
    var option = {
      xAxis: {
        type: "category",
        data: ["Users", "Posts", "Views", "Comments"],
        axisTick: {
          show: false,
        },
        axisLine: {
  ...
  if ($exampleEchartBarDataset.length) {
    ...
    var $exampleEchartBarDatasetActive = echarts.init(
      document.getElementById($exampleEchartBarDatasetId)
    );
    // specify chart configuration item and data
    var option = {
      legend: {
  ...
  if ($exampleEchartPieChart.length) {
    ...
    var $exampleEchartPieChartActive = echarts.init(
      document.getElementById($exampleEchartPieChartId)
    );
    // specify chart configuration item and data
    var option = {
      tooltip: {
  ...
  if ($exampleEchartDoughnutChart.length) {
    ...
    var $exampleEchartDoughnutChartActive = echarts.init(
      document.getElementById($exampleEchartDoughnutChartId)
    );
    // specify chart configuration item and data
    var option = {
      tooltip: {
  ...
  if ($exampleEchartScatterSimple.length) {
    ...
    var $exampleEchartScatterSimpleActive = echarts.init(
      document.getElementById($exampleEchartScatterSimpleId)
    );
    // specify chart configuration item and data
    var option = {
      xAxis: {
  ...
  if ($exampleEchartScatterBubble.length) {
    ...
    var $exampleEchartScatterBubbleActive = echarts.init(
      document.getElementById($exampleEchartScatterBubbleId)
    );
    // specify chart configuration item and data
    var data = [
      [
